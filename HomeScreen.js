  ...
  render(){
    return(
      ...
      <Text style={styles.btntxt}>Read a Joke</Text>
       ...
       <TouchableOpacity style={styles.button} onPress={()=>this.props.navigation.navigate('HoeoScopeScreen')}>
      ...
      <Text style={styles.btntxt}>Weather</Text>
       ...
       <TouchableOpacity style={styles.button} onPress={()=>this.props.navigation.navigate('NewsScreen')}>
